...
It reads the macro DSH, seed audit, RQGM, J-lens gate, live-provider gate, live
smoke, live sequence, and live DSH pilot artifacts, verifies their ledgers, and
emits a result table, claim matrix, metrics JSON, replay bundle, result card,
and its own chained ledger.
...
including the live sequence, the consolidated final report, a manifest, replay
context, result card, metrics JSON, and its own chained ledger.
