...
bias suite, J-lens gates, live-provider gates, live smoke, live sequence, and
...
ledger. It also surfaces the macro diagnostics required by the handoff:
...
including the A/B behavioral bias suite, ledger stress proof, live sequence,
