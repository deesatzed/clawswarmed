...
It reads the macro DSH, seed audit, RQGM, J-lens gate, and live-provider gate
artifacts, verifies their ledgers, and emits a result table, claim matrix,
metrics JSON, replay bundle, result card, and its own chained ledger.
