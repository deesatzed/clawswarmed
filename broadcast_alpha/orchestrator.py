...
def run_all(
    ...
    replay_contexts = {
        "agent_1": {
            "1": "unattended bundle: generated ledger stress, synthetic, DSH, RQGM, J-lens gate, J-lens runtime readiness, J-lens smoke, live model gate, live smoke, live DSH pilot, live sequence, and final report artifacts",
